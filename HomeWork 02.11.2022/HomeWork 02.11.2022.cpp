...
int main()
{
	...
	cout << "Введите количество звёздочек (должен быть квадрат какого-либо числа) либо число, кратное 4" << endl; // Надо больше 4, 2, 3 по заданиям, я в 1 вкинул, мне впадлу много делать
	do {
		cout << "N = ";
		cin >> N;
		a = sqrt(N);
	...
	cout << "Введите длину стороны (больше 2)" << endl;
	do {
		cout << "N = ";
		cin >> N;
	} while (N < 2);
	...
	cout << "Введите длину стороны (больше 3)" << endl;
	do {
		cout << "N = ";
		cin >> N;
	} while (N < 2);
